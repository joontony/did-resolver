package org.snubi.did.resolver.security;
/*
...
import org.snubi.did.resolver.exception.CustomAccessDeniedHandler;
import org.snubi.did.resolver.exception.CustomAuthenticationEntryPoint;
...
public class SpringSecurityConfig {		
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://172.30.1.26:3000","http://localhost:8081","http://localhost:30001","http://localhost:3000","https://avchain8.snubi.org:19901")); 		
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {       
		...
		.authorizeHttpRequests(authorize -> authorize
				.antMatchers("/brain/user/**").authenticated()
				.antMatchers("/brain/study/**").authenticated()				
